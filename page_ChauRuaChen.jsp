...
<sql:query dataSource="${ds}" var="products">
    SELECT * FROM chauruachen_sanpham
...
<header>
    ...
    <nav>
        <form class="search-form" method="get" action="page_ChauRuaChen.jsp">
            <input
                type="text"
                name="search"
                class="search-input"
...
<div class="menu-container">
    ...
    <div class="top-menu">
        <ul>
            ...
            <li class="active"><a href="page_ChauRuaChen.jsp">Chậu Rửa Chén </a></li>
...
=======
  <head>
    <meta charset="UTF-8" />
    <title>Trang Chậu Rửa Chén</title>
    <link
      rel="stylesheet"
