        ...
        <c:otherwise>
            ...
            <c:choose>
                <c:when test="${not empty dbError}">
                    <c:set var="message" value="Đăng ký thất bại: Tài khoản hoặc Email đã tồn tại!" />
                    <c:set var="msgColor" value="red" />
                </c:when>
                ...
                <c:otherwise>
                    <c:set var="message" value="Đăng ký không thành công. Vui lòng thử lại." />
                    <c:set var="msgColor" value="red" />
                </c:otherwise>
            </c:choose>
        </c:otherwise>
  ...
  <body>
    ...
    <div class="register-container">
      ...
      <c:if test="${not empty message}">
          <div style="text-align: center; color: ${msgColor}; margin-bottom: 10px; font-weight: bold;">
              ${message}
          </div>
      </c:if>
