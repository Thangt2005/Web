...
<header>
    ...
    <nav>
        <form class="search-form" method="get" action="TuLavabo">
            <input type="text" name="search" class="search-input" placeholder="Tìm kiếm tủ lavabo..."
...
<main class="main-content">
    ...
    <% } else { %>
    <h2>Sản phẩm Tủ Lavabo Nổi Bật</h2>
    <% } %>
