...
<head>
    ...
    <base href="<%=basePath%>">
    <meta charset="UTF-8">
    <title>Sản Phẩm Tủ Lavabo</title>
...
<header>
    ...
    <nav>
        <div style="position: relative; display: inline-block;">
            <form class="search-form" method="get" action="TuLavabo" autocomplete="off">
                <input type="text" id="search-input" name="search" class="search-input"
                       placeholder="Tìm kiếm tủ lavabo..."
...
<div class="menu-container">
    ...
    <div class="top-menu">
        <ul>
            ...
            <li><a href="TuLavabo" class="active">Tủ Lavabo</a></li>
...
<main class="main-content">
    ...
    <div class="product-grid">
        ...
        <div class="product-card">
            ...
            <h3>
                <a href="ProductDetail?id=<%= p.getId() %>&category=tulavabo_sanpham">
                    <%= p.getTenSp() %>
                </a>
            </h3>
            <p class="price">
            ...
            <div class="button-group">
                <button class="add-to-cart" type="button"
                        onclick="window.location.href='Cart?id=<%= p.getId() %>&category=tulavabo_sanpham'">
        ...
        <div style="text-align: center; width: 100%; padding: 40px; color: #666;">
            ...
            <a href="TuLavabo" style="color: #007bff; text-decoration: underline;">Tải lại trang</a>
        </div>
        <% } %>
    </div>
</main>
